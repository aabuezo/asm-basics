...
_start:
    ...
    lea r15, [callstack]     ;# reserve memory
    ;# lea rsp, [callstack] 
    lea rax, [resume_here]
    mov [r15], rax           ;# push return address
    add r15, 8               ;# move stack pointer
    jmp print_hello
...
resume_hello:
    ...
    mov rax, [r15]  ;# get return address
...
.data
    ...
    callstack: .skip 4096, 0x0 ;# reserve 4KB for call stack
                               ;# 500 calls deep with 8 bytes each
